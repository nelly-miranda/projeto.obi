...
import { X, User, Calendar, Paperclip, Send, Play, Pause, Check, Save } from 'lucide-react'
...
export function TaskModal({ task, isNew, onClose, onUpdate, onCreate, onSendMessage }: TaskModalProps) {
